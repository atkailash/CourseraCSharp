...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Vector2 windowCenter = new Vector2(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2);
            teddy = new Teddy(teddySprite, windowCenter);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (mouse.RightButton == ButtonState.Released)
            {
                ...
                if (rightClickStarted)
                {
                    ...
                    Pickup newPickup = new Pickup(pickupSprite, new Vector2(mouse.X, mouse.Y));
                    if (pickups.Count > 1)
                    {
                        Pickup previousPickup = pickups[pickups.Count - 1];
                    }
