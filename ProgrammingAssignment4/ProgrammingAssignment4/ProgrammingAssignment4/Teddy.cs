...
namespace ProgrammingAssignment4
{
    ...
    public class Teddy
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            {
                this.location.X = (int)(this.velocity.X * gameTime.ElapsedGameTime.Milliseconds) + this.location.X;
                this.location.Y = (int)(this.velocity.Y * gameTime.ElapsedGameTime.Milliseconds) + this.location.Y;
                this.drawRectangle.X = (int)(this.location.X - (sprite.Width / 2));
                this.drawRectangle.Y = (int)(this.location.Y - (sprite.Height / 2));
            }
        ...
        public void SetTarget(Vector2 target)
        {
            ...
            // speed
            this.velocity = target - location;
            this.velocity.Normalize();
            this.velocity = velocity * BASE_SPEED;
        }
